...
<form id="ALCChap4Form" method="POST" action="applilogiccircuit.php" >


  <div class="tab">Notes:
    <div class="notes">
        <embed src="notes/appliexperiment.pdf" width="900vh" height="700vh"/>
  ...
  <div class="tab">Video:
    <div class="video">
    <iframe width="900vh" height="700vh"src="https://www.youtube.com/embed/t5dUCgZwTIA"></iframe>
    </div>
  </div>
...
<script>
  ...
  if (currentTab >= x.length) {
    // ... the form gets submitted:
        document.getElementById("ALCChap4Form").submit();
        <?php
...
$sql = "UPDATE users SET ALCChap4='1' WHERE email = '{$_SESSION['valid_user']}' ";
