...
<header class="page-header gradient">
    ...
    <div class="leftcolumn">
        <h2> Arithmetic & Logical Functions </h2>
    ...
    <span class="vertical-line"></span><br>
    <span class="step"></span>Video C<br>
    <span class="vertical-line"></span><br>
...
<form id="ALCChap1Form" method="POST" action="applilogiccircuit.php" >

  <div class="tab">Notes:
    <div class="notes">
       <!-- <iframe src="https://en.wikipedia.org/wiki/Inverter_(logic_gate)" width="auto" height="auto"></iframe> -->
        <embed src="notes/binaryadder.pdf" width="900vh" height="700vh"/>
      </div>
  </div>
  ...
  <div class="tab">Notes:
    <div class="notes">
       <!-- <iframe src="https://en.wikipedia.org/wiki/Inverter_(logic_gate)" width="auto" height="auto"></iframe> -->
        <embed src="notes/binarysubtractor.pdf" width="900vh" height="700vh"/>
      </div>
  </div>
  ...
  <div class="tab">Notes:
    <div class="notes">
       <!-- <iframe src="https://en.wikipedia.org/wiki/Inverter_(logic_gate)" width="auto" height="auto"></iframe> -->
        <embed src="notes/comparator.pdf" width="900vh" height="700vh"/>
      </div>
  </div>
  ...
  <div class="tab">Notes:
    <div class="notes">
       <!-- <iframe src="https://en.wikipedia.org/wiki/Inverter_(logic_gate)" width="auto" height="auto"></iframe> -->
        <embed src="notes/pld.pdf" width="900vh" height="700vh"/>
      </div>
  </div>

  <div class="tab">Video:
    <div class="video">
    <iframe width="900vh" height="700vh"src="https://www.youtube.com/embed/VI1jXmYh4EE"></iframe>
    </div>
  </div>

  <div class="tab">Video:
    <div class="video">
    <iframe width="900vh" height="700vh"src="https://www.youtube.com/embed/ZJYVNY2EFpE"></iframe>
    </div>
  </div>

  <div class="tab">Video:
    <div class="video">
    <iframe width="900vh" height="700vh" src="https://www.youtube.com/embed/ksvuPza3wPE"></iframe>
    </div>
  </div>
...
<script>
  ...
  if (currentTab >= x.length) {
    // ... the form gets submitted:
        document.getElementById("ALCChap1Form").submit();
        <?php
...
$sql = "UPDATE users SET ALCChap1='1' WHERE email = '{$_SESSION['valid_user']}' ";
