...
<form id="CLCchap2form" method="POST" action="combilogiccircuit.php" >

  <div class="tab">Notes:
    <div class="notes">
       <!-- <iframe src="https://en.wikipedia.org/wiki/Inverter_(logic_gate)" width="auto" height="auto"></iframe> -->
        <embed src="notes/truthtable.pdf" width="900vh" height="700vh"/>
  ...
  <div class="tab">Video:
    <div class="video">
    <iframe width="900vh" height="700vh" src="https://www.youtube.com/embed/C4MdUQJIhSE"></iframe>
    </div>
  </div>
...
<script>
  ...
  if (currentTab >= x.length) {
    // ... the form gets submitted:
        document.getElementById("CLCchap2form").submit();
        <?php
...
$sql = "UPDATE users SET CLCchap2='1' WHERE email = '{$_SESSION['valid_user']}' ";
